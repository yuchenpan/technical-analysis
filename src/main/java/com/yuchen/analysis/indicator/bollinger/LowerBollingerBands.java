...
import static com.yuchen.analysis.indicator.bollinger.BollingerUtils.*;

public class LowerBollingerBands extends Indicator {
    ...
    public LowerBollingerBands(int period, int standardDeviations, Candles candles) {
        super(candles);
        this.period = period;
    ...
    public BigDecimal calculate(int index) {
        ...
        return middleBand.subtract(deviationValue.multiply(new BigDecimal(standardDeviations)), DECIMAL_PLACES);
    }
}
